...
lame_encode_buffer(lame_global_flags * gfp,
                   ...
                   signed char *mp3buf, const int mp3buf_size)
{
...
lame_encode_buffer_interleaved(lame_global_flags * gfp,
                               ...
                               signed char *mp3buf, int mp3buf_size)
{
...
int
lame_encode_flush(lame_global_flags * gfp, signed char *mp3buffer, int mp3buffer_size)
{
    lame_internal_flags *gfc;
